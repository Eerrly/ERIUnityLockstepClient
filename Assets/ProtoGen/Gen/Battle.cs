...
namespace pb {
    ...
    static BattleReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "BWZyYW1lGAIgASgNEg0KBWRhdHVtGAMgASgFIkQKDVMyQ19SZXN1bHRNc2cS",
  ...
  public sealed partial class S2C_FrameMsg : pb::IMessage<S2C_FrameMsg> {
    ...
    public override int GetHashCode() {
      ...
      if (ErrorCode != 0) hash ^= ErrorCode.GetHashCode();
      if (Frame != 0) hash ^= Frame.GetHashCode();
      if (Datum != 0) hash ^= Datum.GetHashCode();
      return hash;
    }
    ...
    public int CalculateSize() {
      ...
      if (Datum != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(Datum);
      }
      return size;
    }
